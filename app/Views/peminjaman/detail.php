            ...
            <?php foreach ($datapeminjaman as $peminjaman) { ?>
              <div class="card-action">
                <?php if (session()->get('role') == 'Admin') { ?>
                  <a href="<?= base_url('peminjaman/hapus/' . $peminjaman->id) ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Hapus Peminjaman</a>
                <?php } ?>
                  <a href="<?= base_url('peminjaman/cetakpeminjaman/' . $peminjaman->id) ?>" class="btn btn-success"><i class="fas fa-print"></i> Cetak Bukti Peminjaman</a>
                <?php if ($peminjaman->status == 'Telah Dikembalikan') { ?>
                  <a href="<?= base_url('peminjaman/cetakpengembalian/' . $peminjaman->id) ?>" class="btn btn-success"><i class="fas fa-print"></i> Cetak Bukti Pengembalian</a>
                <?php } ?>
              </div>
            <?php } ?>
          </div>
